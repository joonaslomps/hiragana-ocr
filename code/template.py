...
image = cv2.imread("../data/templates/da-do/file-page14-crop.jpg", 0)
...
wo_zo = ["wo", "n", "ba", "bi", "bu", "be", "bo", "pa", "pi", "pu", "pe", "po", "ga", "gi", "gu", "ge", "go", "za", "ji", "zu", "ze", "zo"]
	...
	for i in range(14):
		if i != 0:
			if i > 8:
				...
				cv2.imwrite("../data/templates/singles-test/"+da_do[j]+"_"+str(name)+".png", image[y:h,tmp_x:tmp_w])
